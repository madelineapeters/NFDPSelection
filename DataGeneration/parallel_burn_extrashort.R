...
#Specify allele frequency of interest
FREQlist = c(98)

simFUN = function(i,x,POPlist,kb,SIM,FREQlist,type,alpha,mf){
...
detest.pair = simFUN(sim,x,POPlist,kb,SIM,FREQlist,type,alpha,mf)
